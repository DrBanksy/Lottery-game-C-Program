...
/*-------option 2-------*/
//this function encrypts the users access code
...
/*-------option 3-------*/
//comparing encrypted code with default access code (4523)
...
void exitProgram(void)
{
    ...
    //asks user to enter either "y" or "n" 
    do
    {
        scanf("%s", userInput);
        ...
        //if user enters something other than "y" or "n" then display error
